...
class BaseFinancialSchema(BaseModel):
    ...
    units_note: str | None = Field(description="Units note (e.g., 'In millions, except per share data')", default="")
    consolidation_summary: dict[str, Any] | None = Field(description="Summary of account consolidations for transparency", default=None)
...
class BaseLineItem(BaseModel):
    ...
    parent_section: str | None = Field(description="Name of parent section if applicable", default="")
...
class HierarchicalLineItem(BaseLineItem):
    ...
    values: dict[str, str] = Field(description="Values for each reporting period")
    sub_items: list["HierarchicalLineItem"] | None = Field(description="Sub-items under this account", default=[])
