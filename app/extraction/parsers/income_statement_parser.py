...
from app.schemas.income_statement_schema import IncomeStatementLineItem, IncomeStatementSchema
...
def parse_table_data(raw_text: str, reporting_periods: list[str]) -> list[IncomeStatementLineItem]:
    ...
    for _i, row in enumerate(table_rows):
        ...
        if is_total_line_that_resets_context(account_name):
            ...
            logger.debug("  INFO: Total line detected - resetting section context")
