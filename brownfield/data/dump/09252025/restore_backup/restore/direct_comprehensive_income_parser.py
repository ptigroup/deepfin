...
def parse_comprehensive_income_directly(raw_text_file_path: str) -> ComprehensiveIncomeSchema:
    ...
    print(f"🔄 Found {len(oci_items)} OCI items")
    print(f"📈 Found {len(total_comprehensive_items)} total comprehensive items")
...
if __name__ == "__main__":
    # Test the parser
    result = parse_comprehensive_income_directly("output/raw/comprehensive income_raw.txt")
    print(f"\n🎉 Parsing complete!")
