...
class StructuredFinancialExtractor:
    ...
    def __init__(self):
        ...
        self.llmw_client = LLMWhispererClient(
            ...
            if result.get("status_code") == 202:
                ...
                for attempt in range(30):
                    ...
                    try:
                        ...
                        print(f"⚠️ Status check failed, using sample data: {status_error}")
                        break
                else:
    ...
    def extract_to_json_file(self, file_path: str, output_path: Optional[str] = None) -> str:
        ...
        if not output_path:
            ...
            output_path = f"output/structured/json/{base_name}_structured.json"
    ...
    def extract_to_excel_file(self, file_path: str, output_path: Optional[str] = None) -> str:
        ...
        if not output_path:
            base_name = os.path.splitext(os.path.basename(file_path))[0]
            output_path = f"output/structured/excel/{base_name}_structured.xlsx"
